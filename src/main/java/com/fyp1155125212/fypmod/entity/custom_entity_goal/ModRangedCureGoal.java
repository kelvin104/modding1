...
public class ModRangedCureGoal extends Goal {
    ...
    public ModRangedCureGoal(IRangedAttackMob attacker, double movespeed, int maxAttackTime, float maxAttackDistanceIn) {
        this(attacker, movespeed, maxAttackTime, maxAttackTime, maxAttackDistanceIn);
    }

    public ModRangedCureGoal(IRangedAttackMob attacker, double movespeed, int minAttackTime, int maxAttackTime, float maxAttackDistanceIn) {
    ...
    public boolean shouldExecute() {
        ...
        if (livingentity != null && livingentity.isAlive() && (livingentity instanceof AbstractVillagerEntity) && ((livingentity.isPotionActive(EffectInit.SICKNESS.get()))||(livingentity.isPotionActive(EffectInit.SEVERE_SICKNESS.get())))) {
