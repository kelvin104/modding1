...
public class PoliceModel<T extends Police> extends SegmentedModel<T> implements IHasArm, IHasHead {
    ...
    public PoliceModel(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
