package com.fyp1155125212.fypmod.entity.model;
...
public class NeutralCitizen_NModel<T extends NeutralCitizen_N> extends SegmentedModel<T> implements IHasArm, IHasHead {
    ...
    public NeutralCitizen_NModel(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
