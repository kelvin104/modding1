...
public class DoctorModel<T extends Doctor> extends SegmentedModel<T> implements IHasArm, IHasHead {
    ...
    public DoctorModel(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
