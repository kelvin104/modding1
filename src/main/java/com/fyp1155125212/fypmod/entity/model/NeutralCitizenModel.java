...
public class NeutralCitizenModel<T extends NeutralCitizen> extends SegmentedModel<T> implements IHasArm, IHasHead {
    ...
    public NeutralCitizenModel(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
