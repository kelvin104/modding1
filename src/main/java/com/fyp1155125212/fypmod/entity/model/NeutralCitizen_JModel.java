...
public class NeutralCitizen_JModel<T extends NeutralCitizen_J> extends SegmentedModel<T> implements IHasArm, IHasHead {
    ...
    public NeutralCitizen_JModel(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
